...
-- CreateEnum
CREATE TYPE "OpportunityType" AS ENUM ('INTERNSHIP', 'SCHOLARSHIP', 'EXCHANGE_PROGRAM', 'RESEARCH_FELLOWSHIP', 'GRADUATE_PROGRAM', 'FREELANCE', 'FULL_TIME', 'PART_TIME');

-- CreateEnum
CREATE TYPE "CvType" AS ENUM ('TECHNOLOGY', 'SALES', 'MARKETING', 'SOCIAL_MEDIA', 'DESIGN', 'FINANCE');

-- CreateEnum
CREATE TYPE "CvSectionType" AS ENUM ('SUMMARY', 'EXPERIENCE', 'EDUCATION', 'SKILLS', 'PROJECTS', 'CERTIFICATIONS', 'LANGUAGES', 'CONTACT');
