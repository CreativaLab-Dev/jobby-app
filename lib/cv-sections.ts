      ...
      fields: [
        {
          ...
          example: "María Elena González Rodríguez",
        },
        {
          name: "email",
          label: "Email",
        ...
        },
        {
          ...
          type: "tel",
          required: true,
          tip: "Incluye código de país si buscas oportunidades internacionales",
    ...
    },
    {
      ...
      fields: [
        ...
        },
        {
          ...
          example: "Licenciatura en Ingeniería en Sistemas Computacionales",
        },
        {
          name: "institution",
          label: "Institución",
          ...
          example: "Instituto Tecnológico de Monterrey",
        },
        {
          name: "year",
          ...
          type: "text",
          required: true,
          tip: "Si estás estudiando, usa 'Esperado 2025' o el año que planeas graduarte",
          example: "2024 o Esperado 2025",
        },
        {
          name: "gpa",
          label: "Promedio/Calificación (opcional)",
          type: "text",
          required: false,
        ...
        },
        {
          ...
          type: "select",
          required: true,
          options: ["Completado", "En curso"],
          tip: "Indica tu situación actual con respecto a este programa educativo",
        },
      ],
    },
  ]
